...
| UAT-027 | — | P2 | TSF | ☐ Pass ☐ Fail ☐ N/A → **N/A** | ☐ N/A → **N/A** | | | ☑ N/A |
...
| ID | AC | P | Hasil |
|----|----|---|-------|
| UAT-070 | AC-16, AC-35, T-27 | P2 | ☐ Pass ☐ Fail ☐ N/A → **N/A** | ☐ N/A → **N/A** | | | ☑ **PARTIAL** (local sync OK) |
...
|----|-----------|-------------|------|
| LIVE-SMOKE | PASS | live | TMS_RELEASE=6.7.6 (expected 6.7.6) |
