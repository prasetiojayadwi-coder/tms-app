...
def check_html_integrity():
    ...
    for fn in ('renderCustomerMaster', 'debouncedRenderCustomerMaster', 'populateServiceCustomerSelects', 'searchCustomersForPick', 'searchCustomerUnitsForPick', 'selectSvcMasterCustomer', 'onSvcPickCustomerInput', 'onSvcPickUnitInput', 'onPickServiceCustomer', 'onPickServiceUnit', 'triggerServicePhotoPick', 'onServicePhotoPicked', 'resolveServiceTicketAssignedTs', 'applyServiceModalTsPicker', 'relinkServiceTicketsForUser', 'healAllServiceTicketPj', 'healServiceTicketsForCurrentUser', 'getUnitServiceHistory', 'buildServiceHistoryIndex', 'openServiceModalForUnit', 'smartFillServiceByCustomerName', 'applyLastServiceComplaint'):
        if f'function {fn}' in js:
